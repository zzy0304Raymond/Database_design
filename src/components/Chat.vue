    ...
    <div class="chat-window">
      ...
      <div class="chat-body" ref="chatBody">
        <div v-for="message in messages" :key="message.id" class="chat-message"
          :class="{ 'my-message': message.from === currentUser }">
      ...
      <div class="chat-input-area">
        <el-input type="textarea" v-model="chatMessage" placeholder="Type your message here..." class="chat-input"
          @keyup.enter="sendMessage" @input="notifyTyping"></el-input>
...
export default {
  ...
  methods: {
    async fetchChatHistory(senderId) {
      try {
        const response = await axios.get(`${BACKEND_BASE_URL}/chats/${senderId}`);
